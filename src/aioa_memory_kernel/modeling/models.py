...
class ModelReasonCode(StableStringEnum):
    ...
    MODEL_REQUEST_LIMIT_EXHAUSTED = "MODEL_REQUEST_LIMIT_EXHAUSTED"
    MODEL_CALL_LIMIT_EXHAUSTED = "MODEL_CALL_LIMIT_EXHAUSTED"
    MODEL_BUDGET_EXHAUSTED = "MODEL_BUDGET_EXHAUSTED"
    MODEL_CONCURRENCY_LIMIT = "MODEL_CONCURRENCY_LIMIT"
    MODEL_REQUEST_SCOPE_REQUIRED = "MODEL_REQUEST_SCOPE_REQUIRED"
    MODEL_DUPLICATE_REQUEST = "MODEL_DUPLICATE_REQUEST"
